<?php
  ...
  if ($_GET["ruta"] == "productos-ventas" && !isset($_GET["fechaInicial"]) && !isset($_GET["fechaFinal"])) {
    ...
    $url = "index.php?ruta=productos-ventas&fechaInicial=".$fechaInicial."&fechaFinal=".$fechaFinal;
  ...
  <section class="content">
    ...
    <div class="box cajaPrincipal">
     ...
     <div class="box-header with-border">
         ...
         <button type="button" class="btn btn-default pull-right" id="daterange-btn-productos">
           <span>
       ...
       <table class="table table-bordered table-striped dt-responsive" width="100%">
        ...
        <thead>
         ...
         <tr>
           ...
           <th style="width:100px">Nro.Factura</th>
        ...
        <?php
          ...
          $facturas = ControladorVentas::ctrRangoFechasVentas($fechaInicial, $fechaFinal);
          ...
          foreach ($facturas as $key => $value) {
            ...
            $productos =  json_decode($value["productos"], true);
              ...
              foreach ($productos as $key => $valueProductos) {
                ...
                <td>'.$valueProductos["codigo"].'</td>

                <td>';
                /* Tomar todo del productos */
                $item = 'id';
                $valor = $value["id"];
                $orden = 'id';
                ...
                <td>'.$valueProductos["descuento"].'</td>
